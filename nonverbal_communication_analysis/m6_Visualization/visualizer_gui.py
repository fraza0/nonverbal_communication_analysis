...
class Ui_Visualizer(object):
    def setupUi(self, Visualizer):
        ...
        self.lbl_frame_idx = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_frame_idx.sizePolicy().hasHeightForWidth())
        self.lbl_frame_idx.setSizePolicy(sizePolicy)
        self.lbl_frame_idx.setReadOnly(True)
        self.lbl_frame_idx.setObjectName("lbl_frame_idx")
        self.gridLayout_5.addWidget(self.lbl_frame_idx, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chb_op_ig_dist, 3, 0, 1, 1)
        ...
        self.chb_op_exp = QtWidgets.QCheckBox(self.fr1_openpose)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.chb_op_exp.sizePolicy().hasHeightForWidth())
        self.chb_op_exp.setSizePolicy(sizePolicy)
        self.chb_op_exp.setObjectName("chb_op_exp")
        self.gridLayout_2.addWidget(self.chb_op_exp, 2, 0, 1, 1)
        self.chb_op_cntr_int = QtWidgets.QCheckBox(self.fr1_openpose)
        self.chb_op_cntr_int.setObjectName("chb_op_cntr_int")
        self.gridLayout_2.addWidget(self.chb_op_cntr_int, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Visualizer):
        ...
        self.lbl_frame_idx.setText(_translate("Visualizer", "0"))
        ...
        self.chb_op_exp.setText(_translate("Visualizer", "Expansiveness"))
