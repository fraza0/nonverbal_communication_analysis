...
class Ui_FeatureAnalyzer(object):
    def setupUi(self, FeatureAnalyzer):
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.cvs_env_interaction)
        ...
        self.cvs_expansiveness = QtWidgets.QWidget(self.groupBox_2)
        self.cvs_expansiveness.setObjectName("cvs_expansiveness")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.cvs_expansiveness)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout()
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.verticalLayout_9.addLayout(self.verticalLayout_7)
        self.verticalLayout_3.addWidget(self.cvs_expansiveness)
