...
class Ui_FeatureAnalyzer(object):
    def setupUi(self, FeatureAnalyzer):
        ...
        FeatureAnalyzer.resize(960, 840)
        ...
        self.cvs_intragroup_dist.setMinimumSize(QtCore.QSize(0, 150))
        ...
        self.cvs_group_energy.setMinimumSize(QtCore.QSize(0, 150))
        ...
        self.cvs_kp_energy_1 = QtWidgets.QWidget(self.groupBox_2)
        self.cvs_kp_energy_1.setMinimumSize(QtCore.QSize(0, 100))
        self.cvs_kp_energy_1.setObjectName("cvs_kp_energy_1")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.cvs_kp_energy_1)
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.verticalLayout_13 = QtWidgets.QVBoxLayout()
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.verticalLayout_14.addLayout(self.verticalLayout_13)
        self.horizontalLayout_2.addWidget(self.cvs_kp_energy_1)
        self.cvs_kp_energy_2 = QtWidgets.QWidget(self.groupBox_2)
        self.cvs_kp_energy_2.setObjectName("cvs_kp_energy_2")
        self.verticalLayout_21 = QtWidgets.QVBoxLayout(self.cvs_kp_energy_2)
        self.verticalLayout_21.setObjectName("verticalLayout_21")
        self.verticalLayout_19 = QtWidgets.QVBoxLayout()
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.verticalLayout_21.addLayout(self.verticalLayout_19)
        self.horizontalLayout_2.addWidget(self.cvs_kp_energy_2)
        self.cvs_kp_energy_3 = QtWidgets.QWidget(self.groupBox_2)
        self.cvs_kp_energy_3.setObjectName("cvs_kp_energy_3")
        self.verticalLayout_22 = QtWidgets.QVBoxLayout(self.cvs_kp_energy_3)
        self.verticalLayout_22.setObjectName("verticalLayout_22")
        self.verticalLayout_20 = QtWidgets.QVBoxLayout()
        self.verticalLayout_20.setObjectName("verticalLayout_20")
        self.verticalLayout_22.addLayout(self.verticalLayout_20)
        self.horizontalLayout_2.addWidget(self.cvs_kp_energy_3)
        ...
        self.cvs_overlap_1.setMinimumSize(QtCore.QSize(0, 100))
        ...
        self.cvs_env_interaction.setMinimumSize(QtCore.QSize(0, 150))
    ...
    def retranslateUi(self, FeatureAnalyzer):
        ...
        self.label_4.setText(_translate("FeatureAnalyzer", "Keypoint Energy"))
