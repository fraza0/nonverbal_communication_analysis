...
class Ui_FeatureComparator(object):
    def setupUi(self, FeatureComparator):
        ...
        self.chb_trend = QtWidgets.QCheckBox(self.frame_filters)
        self.chb_trend.setObjectName("chb_trend")
        self.horizontalLayout_7.addWidget(self.chb_trend)
    ...
    def retranslateUi(self, FeatureComparator):
        ...
        self.chb_trend.setText(_translate("FeatureComparator", "Trendline"))
