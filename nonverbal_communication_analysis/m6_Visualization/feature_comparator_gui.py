...
class Ui_FeatureComparator(object):
    def setupUi(self, FeatureComparator):
        ...
        self.chb_raw = QtWidgets.QCheckBox(self.frame_filters)
        self.chb_raw.setObjectName("chb_raw")
        self.horizontalLayout_7.addWidget(self.chb_raw)
        self.chb_poly = QtWidgets.QCheckBox(self.frame_filters)
        self.chb_poly.setObjectName("chb_poly")
        self.horizontalLayout_7.addWidget(self.chb_poly)
        self.chb_moving_avg = QtWidgets.QCheckBox(self.frame_filters)
        self.chb_moving_avg.setObjectName("chb_moving_avg")
        self.horizontalLayout_7.addWidget(self.chb_moving_avg)
        self.chb_spline = QtWidgets.QCheckBox(self.frame_filters)
        self.chb_spline.setChecked(True)
        self.chb_spline.setObjectName("chb_spline")
        self.horizontalLayout_7.addWidget(self.chb_spline)
    ...
    def retranslateUi(self, FeatureComparator):
        ...
        self.chb_raw.setText(_translate("FeatureComparator", "Raw"))
        self.chb_poly.setText(_translate("FeatureComparator", "Poly"))
        self.chb_moving_avg.setText(_translate("FeatureComparator", "Moving Average"))
        self.chb_spline.setText(_translate("FeatureComparator", "Spline"))
